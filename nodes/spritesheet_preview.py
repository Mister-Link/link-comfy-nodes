...
class SpritesheetPreviewNode:
    """Preview a spritesheet as an animated GIF/WebP with configurable parsing parameters."""
    ...
    def preview_spritesheet(
        ...
        """Save the spritesheet and return animation data for UI-based animation."""
        if not isinstance(spritesheet, torch.Tensor):
            return {"ui": {"spritesheet_data": []}}

        # Get the spritesheet as numpy array
        ...
        # Scale frame dimensions and spritesheet
        ...
        # Save the scaled spritesheet as a lossless WebP
        pil_sheet.save(spritesheet_filepath, format="WEBP", lossless=True)

        # Extract frames and create animated WebP
        frames = []
        ...
        for i in range(total_frames):
            ...
            # Ensure we don't crop beyond the image bounds
                ...
                "spritesheet_data": [
                    {
                        ...
                        # Metadata for client-side animation
                        "frame_width": scaled_frame_width,
                        "frame_height": scaled_frame_height,
                        "columns": columns,
                        "total_frames": total_frames,
                        "fps": fps,
                        # Animation file for opening in new tab
