...
const SPIRE_REFERENCE = {
  ...
  width: 35,
  height: 80,
  // Canonical large frame/canvas used by the normalizer for this preset.
  upscaledWidth: 512,
  upscaledHeight: 1152,
...
const PRESET_DIMENSIONS = {
  Spirie: {
    ...
    upscaledWidth: SPIRE_REFERENCE.upscaledWidth,
    upscaledHeight: SPIRE_REFERENCE.upscaledHeight,
  },
};
