...
NODE_CLASS_MAPPINGS = {
    ...
    "Match Colors to Reference (v2)": MatchColorsToReferenceV2Node,
    ...
    "Stabilize Frames": StabilizeFramesNode,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "Match Colors to Reference (v2)": "Match Colors to Reference (v2)",
    ...
    "Stabilize Frames": "Stabilize Frames",
