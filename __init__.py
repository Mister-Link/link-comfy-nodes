...
NODE_CLASS_MAPPINGS = {
    ...
    "WanVace Strength Patch": WanVaceStrengthPatch,
    "WanVaceToVideo (Control Strength)": WanVaceToVideoControlStrength,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "WanVace Strength Patch": "WanVace Strength Patch",
    "WanVaceToVideo (Control Strength)": "WanVaceToVideo (Control Strength)",
